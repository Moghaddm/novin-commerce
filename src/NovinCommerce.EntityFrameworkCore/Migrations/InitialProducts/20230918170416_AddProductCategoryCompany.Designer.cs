...
{
    [DbContext(typeof(NovinCommerceDbContext))]
    [Migration("20230918170416_AddProductCategoryCompany")]
    partial class AddProductCategoryCompany
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("NovinCommerce.Entities.Categories.Category", b =>
                {
                    b.Property<Guid>("Id")
            ...
            modelBuilder.Entity("NovinCommerce.Entities.Companies.Company", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("NovinCommerce.Entities.Products.Product", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("NovinCommerce.Entities.Products.Product", b =>
                {
                    b.HasOne("NovinCommerce.Entities.Categories.Category", "Category")
                        .WithMany("Products")
                        .HasForeignKey("CategoryId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("NovinCommerce.Entities.Companies.Company", "Company")
                        .WithMany()
