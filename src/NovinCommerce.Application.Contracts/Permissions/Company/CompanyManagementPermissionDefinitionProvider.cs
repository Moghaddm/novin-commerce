...
public class CompanyManagementPermissionDefinitionProvider : PermissionDefinitionProvider
{
    public override void Define(IPermissionDefinitionContext context)
    {
        ...
        var categoryPermission = categoryGroup.AddPermission(NovinCommercePermissions.Companies.Default,
            L("Permission:CompanyManagement"));

        categoryPermission.AddChild(NovinCommercePermissions.Companies.Create,
            L("Permission:CompanyManagement:Create"));
        categoryPermission.AddChild(NovinCommercePermissions.Companies.Delete,
            L("Permission:CompanyManagement:Delete"));
