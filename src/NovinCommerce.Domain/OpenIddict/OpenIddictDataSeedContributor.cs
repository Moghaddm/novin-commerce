...
namespace NovinCommerce.OpenIddict;
...
public class OpenIddictDataSeedContributor : IDataSeedContributor, ITransientDependency
{
    ...
    private async Task CreateApplicationsAsync()
    {
        ...
        //Web Client
        var webClientId = configurationSection["NovinCommerce_Web:ClientId"];
        if (!webClientId.IsNullOrWhiteSpace())
        {
            var webClientRootUrl = configurationSection["NovinCommerce_Web:RootUrl"].EnsureEndsWith('/');
        ...
        var consoleAndAngularClientId = configurationSection["NovinCommerce_App:ClientId"];
        ...
        // Blazor Client
        var blazorClientId = configurationSection["NovinCommerce_Blazor:ClientId"];
        ...
        var blazorServerTieredClientId = configurationSection["NovinCommerce_BlazorServerTiered:ClientId"];
        ...
        // Swagger Client
        var swaggerClientId = configurationSection["NovinCommerce_Swagger:ClientId"];
