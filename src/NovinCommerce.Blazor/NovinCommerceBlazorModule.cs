...
[DependsOn(
    ...
    typeof(NovinCommerceHttpApiModule),
    ...
    public class NovinCommerceBlazorModule : AbpModule
{
    public override void PreConfigureServices(ServiceConfigurationContext context)
    {
        context.Services.PreConfigure<AbpMvcDataAnnotationsLocalizationOptions>(options =>
        {
            options.AddAssemblyResource(
                typeof(NovinCommerceResource),
                typeof(NovinCommerceDomainModule).Assembly,
                typeof(NovinCommerceDomainSharedModule).Assembly,
                typeof(NovinCommerceApplicationModule).Assembly,
                typeof(NovinCommerceApplicationContractsModule).Assembly,
                typeof(NovinCommerceBlazorModule).Assembly
            );
        });
        ...
        PreConfigure<OpenIddictBuilder>(builder =>
        {
            ...
            {
                options.AddAudiences("NovinCommerce");
        ...
        Configure<AbpBundlingOptions>(options =>
        {
            ...
            options.StyleBundles.Configure(
                ...
                bundle =>
                {
                    ...
                    bundle.AddFiles("/NovinCommerce.Blazor.styles.css");
                }
            );
        });
    }
    ...
    private void ConfigureSwaggerServices(IServiceCollection services)
    {
        services.AddAbpSwaggerGen(
            options =>
            {
                options.SwaggerDoc("v1", new OpenApiInfo { Title = "NovinCommerce API", Version = "v1" });
    ...
    private void ConfigureMenu(ServiceConfigurationContext context)
    {
        ...
        {
            options.MenuContributors.Add(new NovinCommerceMenuContributor());
        });
    }
    ...
    private void ConfigureAutoApiControllers()
    {
        ...
        {
            options.ConventionalControllers.Create(typeof(NovinCommerceApplicationModule).Assembly);
        });
    }
